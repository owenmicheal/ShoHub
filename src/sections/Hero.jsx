...
const Hero = () => {
  ...
  return (
    <section
      id="home"
      className="w-full flex xl:flex-row flex-co justify-center
    ...
    >
      ...
      >
        ...
        <h1 className="mt-10 font-palanquin text-8xl max-sm:text-[72px]
          ...
          <br/>
          <span className="text-coral-red inline-block mt-3">Najji</span> Shoes
        </h1>
        <p className="font-montserrat text-slate-gray text-lg leading-8 mt-6 mb-14 sm:max-w-sm">Discover Styelish ShoeHub Arrivals, quality comfort, and innovation for active life.</p>
